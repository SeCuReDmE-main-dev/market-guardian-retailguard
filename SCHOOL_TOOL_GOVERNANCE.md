...
This repository uses the Secured Educational Cybersecurity License 2.0 (`LicenseRef-SECL-2.0`) because it is a market visual helper for small-store protection and supervised cybersecurity/retail-safety education.
